...
def main() -> None:
    ...
    entity_delta = (
        planned_census.implementation_entities - baseline_census.implementation_entities
    )
    phase_delay_delta = (
        planned_census.phase_delay_entities - baseline_census.phase_delay_entities
    )
    print(
        "\nrealized abstract delta: "
        f"entities={entity_delta:+d}; "
        f"phase_delays={phase_delay_delta:+d}; "

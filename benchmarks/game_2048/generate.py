"""Compile and emit the interactive 2048 benchmark blueprint."""
...
from benchmarks.game_2048.model import build_2048_circuit
...
def main() -> None:
    ...
    result = build_2048_circuit().compile(optimize=args.optimize, placement=placement)
    ...
    print(
        "controls: N/E/S/W move; NW resets; remain in a region = no repeat; "
        "return through neutral/unused diagonal space to re-arm",
        file=sys.stderr,
    )
